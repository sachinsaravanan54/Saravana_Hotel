...
const FOOD_IMAGES = {
  'Idly': './frontend/images/food_idly.png',
  'Dosa': './frontend/images/food_dosa.png',
  'Parotta': './frontend/images/food_parotta.png',
  'Poori': './frontend/images/food_poori.png',
  'Pongal': './frontend/images/food_pongal.png',
  'Vada': './frontend/images/food_vada.png',
  'Chappathi': './frontend/images/food_chappathi.png',
  'Full Meals': './frontend/images/food_meals.png'
};
    ...
    cartItemsList.innerHTML = cart.map(item => `
      <div class="cart-item" id="cart-row-${item.name.replace(/\s/g,'_')}">
        <img class="cart-item-img"
          src="${FOOD_IMAGES[item.name] || './frontend/images/food_idly.png'}"
          alt="${item.name}" />
